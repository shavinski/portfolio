...
>>>>>>> parent of 23e1605 (Finish Home component)
                <div className="container-info">
                    ...
                    <div> I'm baby palo santo intelligentsia truffaut activated charcoal. Hot chicken bodega boys yuccie viral, VHS plaid listicle woke normcore vexillologist. Taxidermy chambray williamsburg leggings. Photo booth bushwick Brooklyn banjo put a bird on it. Four loko tumblr deep v, DIY fashion axe tilde craft beer. Same la croix tumblr heirloom. </div>
                    ...
                    <div className='container-connect'>
                            <div className='connect'>
                                <a href="#contact">
                                    Lets Connect<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up-right-square" viewBox="0 0 16 16">
